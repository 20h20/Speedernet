<?php
    if( function_exists('acf_register_block_type') ):
        ...
        function cbo_render_contact_block( $block, $content = '', $is_preview = false, $post_id = 0 ) {
            $has_content = get_field('contact_title') || get_field('contact_form_id');
            ...
            include get_stylesheet_directory() . '/templates/blocks/contact/template.php';
        }
        ...
        acf_register_block_type(array(
            ...
            'category'        => 'text',
            'keywords'        => array('contact', 'formulaire', 'adresse'),
            'post_types'      => array(),
            'mode'            => 'auto',
            'align'           => '',
            'render_callback' => 'cbo_render_contact_block',
