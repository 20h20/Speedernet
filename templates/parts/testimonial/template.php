...
$post_id    = get_the_ID();
$categories = get_the_terms( $post_id, 'testimonials_cat' );
$name       = get_field('testimonial_name', $post_id);
$function   = get_field('testimonial_function', $post_id);

$title_id = 'testimonial-title-' . $post_id;
	...
	<a class="el-inner slide-up" href="<?php the_permalink(); ?>" itemprop="url" aria-label="<?php echo esc_attr( pll__('Voir l\'interview') . ' : ' . get_the_title() ); ?>">
		<div class="inner-content">
			...
			<div class="content-text">
				...
				<div id="<?php echo esc_attr( $title_id ); ?>" class="content-title cbo-title-4 slide-up" itemprop="name">
		...
		<div class="inner-link cbo-link slide-up">
			...
			<span class="link-button button--player" aria-hidden="true">
